...
namespace WinFormsNetFxDemo.Pages
{
    public class DataPanel : Panel
    {
        ...
        private void OnCellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                case "Active":
                    bg = ColorTranslator.FromHtml("#064E3B");
                    fg = ColorTranslator.FromHtml("#34D399");
                    break;
                case "Inactive":
                    bg = ColorTranslator.FromHtml("#450A0A");
                    fg = ColorTranslator.FromHtml("#F87171");
                    break;
                case "Pending":
                    bg = ColorTranslator.FromHtml("#451A03");
                    fg = ColorTranslator.FromHtml("#FBBF24");
                    break;
                default:
                    bg = CardColor;
                    fg = TextPrimary;
