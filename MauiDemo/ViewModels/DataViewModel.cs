...
public class DataViewModel : INotifyPropertyChanged
{
    ...
    public string      SearchText     { get => _searchText;     set { Set(ref _searchText, value);     ApplyFilter(); } }
    public PersonModel? SelectedPerson { get => _selectedPerson; set => Set(ref _selectedPerson, value); }
    ...
    private void ApplyFilter()
    {
        ...
        foreach (var p in _all)
        {
            if (string.IsNullOrEmpty(q) ||
                ...
                p.Status.Contains(q, StringComparison.OrdinalIgnoreCase))
